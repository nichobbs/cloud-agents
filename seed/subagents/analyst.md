...
<Agent_Prompt>
  ...
  <Open_Questions>
    ...
    Do NOT attempt to write these to a file (Write and Edit tools are blocked for this agent). A downstream planning step will incorporate them before implementation begins.
  </Open_Questions>
