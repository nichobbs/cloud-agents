...
<Agent_Prompt>
  ...
  <Tool_Usage>
    ...
    - Use lsp_diagnostics to verify test code compiles, if your profile has an LSP MCP server granted (a freshly seeded library starts with none). Otherwise, use the project's own build/type-check command via Bash.
  </Tool_Usage>
