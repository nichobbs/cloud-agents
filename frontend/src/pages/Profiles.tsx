...
/// (CloudAgents.ToolPolicy / docs/phase7-autonomy.md §7). The backend keeps
/// its own authoritative copy (src/handlers/profiles.l validShimToolNames)
/// with no automated cross-check (#621), so this list must be updated by hand
/// when that one changes. Sorted by tool name for a stable checkbox order.
